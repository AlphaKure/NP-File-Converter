    ...
    if not os.path.isdir(path):
        ...
        for dir in dirlist:
            if not os.path.isdir(path+dir):
                ...
                if not data.find('shorteningGridCountList'):
                    shorteningGridCountList=BeautifulSoup('<shorteningGridCountList><MapAreaGridShorteningData><count>0</count></MapAreaGridShorteningData><MapAreaGridShorteningData><count>0</count></MapAreaGridShorteningData><MapAreaGridShorteningData><count>0</count></MapAreaGridShorteningData><MapAreaGridShorteningData><count>0</count></MapAreaGridShorteningData><MapAreaGridShorteningData><count>0</count></MapAreaGridShorteningData><MapAreaGridShorteningData><count>0</count></MapAreaGridShorteningData><MapAreaGridShorteningData><count>0</count></MapAreaGridShorteningData><MapAreaGridShorteningData><count>0</count></MapAreaGridShorteningData></shorteningGridCountList>','xml')
                    data.find('mapAreaBoostMultiple').insert_after(shorteningGridCountList)
